...
feature -- Filenames
	...
	css_file_name: STRING is "style.css"
	...
	cluster_file_name (a_cluster: ET_CLUSTER): STRING is
		...
		do
			Result := "cluster."+a_cluster.prefixed_name.as_lower+".html"
		ensure
	...
	class_file_name (a_class: ET_CLASS): STRING is
		...
		do
			Result := a_class.name.name.as_lower+".html"
		ensure
	...
	usage_file_name (a_class: ET_CLASS): STRING is
		...
		require
			a_class_not_void: a_class /= Void
		do
			Result := "usage."+a_class.name.name.as_lower+".html"
		ensure
			usage_file_name_not_void: Result /= Void
		end

	overview_file_name: STRING is "index.html"
			-- Filename of overview

	classes_file_name: STRING is "classes.all.html"
			-- Filename of classes file

	clusters_file_name: STRING is "clusters.all.html"
			-- Filename of classes file
	...
	index_file_name (a_character: CHARACTER): STRING is
		...
		do
			Result := "index-"+CHARACTER_.as_lower (a_character).out+".html"
		ensure
...
feature -- Links
	...
	relative_css_link: STRING is
			-- Link to css file
		do
			Result := Context.relative_output_directory+css_file_name
		ensure
